...
## [1.0.5] - 2026-03-30
### Fixed
- **Build Configuration**: Fixed JitPack build failure by aligning JDK toolchain and publishing settings.

## [1.0.4] - 2026-03-30

### Changed
- **KotlinPdfium Update**: Updated to version 1.0.4.
- **Dependency Optimization**: Removed unnecessary dependencies to further reduce library footprint.
